...
function fake(
  ...
  return {
    ...
    markToolExecutionStarted: Effect.fn("TestSessionProcessor.markToolExecutionStarted")(() => Effect.void),
    finalizeFailure: Effect.fn("TestSessionProcessor.finalizeFailure")(() => Effect.void),
